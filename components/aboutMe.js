        ...
        <div className="pt-20 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-20 gap-x-20">
          ...
          <div className="inline-flex flex-col">
            <div>
              ...
              <p className="text-lg text-gray-500 mt-4 dark:text-gray-300 text-justify">
                For any help or inquiries, shoot an{" "}
                <a
            ...
            <div className="mt-8">
              ...
              <p className="text-lg text-gray-500 mt-4 dark:text-gray-300 text-justify">
              I am actively seeking new project opportunities. If you believe I could be a strong fit, please review my{" "}
                <a
                ...
                and I would be thrilled to contribute.
              </p>
            </div>
            {/* Social Links */}
          ...
          <div className="col-span-1 md:col-span-2 text-justify">
            {userData.about.description?.map((desc, idx) => (
              <p
                key={idx}
                className="text-lg text-gray-500 mb-4 dark:text-gray-300 "
              >
                {desc}
              </p>
            ))}

            <h1 className="bg-red-500 text-2xl mt-8 rounded-md px-2 py-1 inline-block font-bold text-gray-50">
              Tech Stack
            </h1>
